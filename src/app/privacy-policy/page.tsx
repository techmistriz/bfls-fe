      ...
      <section className="w-full bg-white px-5 py-20">
        <div className="mx-auto w-full max-w-[1120px] font-roboto">
          ...
          <p className="mb-[27px] text-[16px] font-normal leading-[1.6] text-[#7A7A7A] max-md:text-[14px]">
            Welcome to Lex Witness – India’s 1st Magazine on Legal & Corporate
            Affairs (“we,” “us,” or “our”). We are committed to protecting your
          ...
          <p className="mb-[27px] text-[16px] font-normal leading-[1.6] text-[#7A7A7A] max-md:text-[14px]">
            ...
            information, such as your IP address, browser type, and usage data,
          ...
          <ul className="mb-[27px] list-disc pl-[38px] max-md:pl-[25px] text-[16px] font-normal leading-[1.6] text-[#7A7A7A] max-md:text-[14px]">
            <li>
              Service providers who help us operate and improve our website
            </li>
          ...
          <p className="mb-[27px] text-[16px] font-normal leading-[1.6] text-[#7A7A7A] max-md:text-[14px]">
            ...
            but no method of transmission over the internet is 100% secure. We
          ...
          <p className="mb-[27px] text-[16px] font-normal leading-[1.6] text-[#7A7A7A] max-md:text-[14px]">
            ...
            policy will be posted on this page with a revised date.
          </p>
          ...
          <p className="mb-[27px] text-[16px] font-normal leading-[1.6] text-[#7A7A7A] max-md:text-[14px]">
            ...
            our data practices, please contact the nominated Data Protection
            Officer;
          </p>

          <p className="text-[#7a7a7a] font-[18px] mt-5 ms-5">
            <strong>Mr. Akshay Alagh</strong>
          </p>
          <p className="text-[#7a7a7a] ms-5 font-[16px]">
            Group Business Head <br />
